    ...
    Column(
        ...
        Row(
            ...
            CustomIconButton(
                ...
                onClick = { transitionScreen(NavigationItems.ChangeBirthday) }
            )
            CustomIconButton(
                contentDescription = "info",
                painter = painterResource(id = R.drawable.outline_info_24),
                onClick = { transitionScreen(NavigationItems.Info) }
            )
            CustomIconButton(
                contentDescription = "settings",
                painter = painterResource(id = R.drawable.outline_settings_24),
                onClick = { transitionScreen(NavigationItems.Settings) }
            )
        }
